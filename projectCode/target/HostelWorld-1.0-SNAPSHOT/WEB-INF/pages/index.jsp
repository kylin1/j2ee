            ...
            <form:form action="login" method="post" role="form">
              ...
              <div class="content" align="middle">
                ...
                <div class="input-group">
                  ...
                  <input required="required" id="account" name="account" type="text" class="form-control" placeholder="账户">
                </div>
                ...
                <div class="input-group">
                  ...
                  <input required="required" id="password" name="password" type="password" placeholder="密码" class="form-control"/>
                </div>
