...
//	@EJB UserManageService userService; 
	...
	UserManageService userService = (UserManageService) EJBFactory
			.getEJB("ejb:/onlineStockJPAEJB/UserManageServiceBean!edu.nju.onlinestock.service.UserManageService");
